...
impl Thm {
    ...
    // `Thm::assume` produces.
    //
    // Each axiom is cached process-wide in a `LazyLock<Thm>`; the
    // public accessors return cheap `Arc` clones.
    ...
    pub fn nat_induction() -> Thm {
        static AX: LazyLock<Thm> = LazyLock::new(|| {
            Thm::build(Ctx::new(), hol::nat_induction_term())
    ...
    pub fn eq_reflection() -> Thm {
        static AX: LazyLock<Thm> = LazyLock::new(|| {
            Thm::build(Ctx::new(), hol::eq_reflection_term())
    ...
    pub fn forall_reflection() -> Thm {
        static AX: LazyLock<Thm> = LazyLock::new(|| {
            Thm::build(Ctx::new(), hol::forall_reflection_term())
    ...
    pub fn imp_reflection() -> Thm {
        static AX: LazyLock<Thm> = LazyLock::new(|| {
            Thm::build(Ctx::new(), hol::imp_reflection_term())
