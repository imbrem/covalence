...
// TODO(cov:kernel.hol.init.src.wasm.builtin-frontier-after-the-integer-leg, severe): Give exact clauses to the remaining 67 float and related builtin declarations.
