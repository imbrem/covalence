...
> **design only** (tracked in `crates/kernel/hol/init/src/SKELETONS.md`).
...
```rust
// crates/kernel/hol/init/src/project.rs
...
narrow-waist picture of `notes/vibes/kernel/kernel-design.md` §11: the Rust "zoo" of
...
Tie-in to the system vision (`notes/vibes/vision/VISION.md`, `notes/vibes/kernel/kernel-design.md` §11):
...
Deferred (see `crates/kernel/hol/init/src/SKELETONS.md`): the Rust→`.cov`
...
[`Env`]: ../../../crates/kernel/hol/init/src/script/env.rs
[`Tactic`]: ../../../crates/kernel/hol/init/src/script/tactic.rs
