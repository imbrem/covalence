...
// TODO(cov:lisp.acl2.admission-layer, severe): Generalize APPEND's checked universal relational-existence proof to admitted definitions, prove uniqueness, totalize only from those theorems, and retire shallow assumed equations.
