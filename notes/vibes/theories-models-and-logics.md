...
`compile_project` (`notes/vibes/cov-project.md`) builds, replacing the hand-written
...
**scoped to a theory** (`notes/vibes/VISION.md`, metatheory-as-default). The outer HOL is
...
- `compile_project` (`notes/vibes/cov-project.md`) — the multi-file `.cov` DAG builder
