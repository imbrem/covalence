...
| [`next-stage-breakdown.md`](./next-stage-breakdown.md) | Execution breakdown of the root [`REFACTOR.md`](../REFACTOR.md) (next stage, post-main-merge): docs split → tooling foundations → hierarchical crate migration → WASM roadmap; sequencing, pilot, open decisions. |
