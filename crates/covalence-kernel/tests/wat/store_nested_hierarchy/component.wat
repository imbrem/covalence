...
(component
    ...
    (core module $m
        ...
        (func $start
            ...
            (local.set $a (call $store_dir (local.get $r) (i32.const 0) (i32.const 1)))
            (local.set $b (call $store_dir (local.get $a) (i32.const 4) (i32.const 1)))
            ...
            (local.set $a2 (call $store_dir (local.get $r) (i32.const 0) (i32.const 1)))
            (local.set $b2 (call $store_dir (local.get $a2) (i32.const 4) (i32.const 1)))
