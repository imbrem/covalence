 ...
 *   https://github.com/BLAKE3-team/BLAKE3/blob/1.8.5/c/blake3_impl.h
 * Upstream commit: 93a431c78a52d7ccf0f366f106467f5070e6075e
 * License: CC0 1.0 OR Apache-2.0.
 *
 * Pristine apart from substituting `<assert.h>` / `<string.h>` for the
 * tiny no-libc shim "cov_compat.h" (whose memcpy/memset/strlen live in
 * main.c). All SIMD detection paths (IS_X86 / IS_AARCH64 /
 * BLAKE3_USE_NEON) remain compiled-out on wasm32-unknown-unknown —
 * only the portable backend is reachable.
 */
