...
///
/// The kernel does **not** designate a canonical "truth" or "false"
/// term — userspace allocates whatever `Bool(true)` (or other "known
/// true" sentinel) it cares about and threads that `TermRef` through
/// every rule call that should mark something as known-true.
