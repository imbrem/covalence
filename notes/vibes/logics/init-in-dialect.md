...
- **The reflected-vs-trusted-type split.** `HolOmega::TyRep = TyC` is the base's
  ...
  `CORE_MANIFEST`. See [`tcb-holomega-roadmap.md`](../kernel/tcb/tcb-holomega-roadmap.md).
...
See also [`backend-decoupling.md`](../observers/backend-decoupling.md) for the api-trait migration story.
