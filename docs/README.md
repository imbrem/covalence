...
| [`covalence-pure.md`](./covalence-pure.md) | The base-logic blueprint: one trusted logic + N executors + K accelerators, everything-as-observers, the two assumption sets (logical + meta-assumption). |
