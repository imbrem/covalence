# The WebAssembly-spec front end (`crates/kernel/hol/init/src/wasm`)
...
Metamath (`init/src/metalogic`) and SpecTec are **dual**:
...
Related: [`metatheory.md`](./metatheory.md) (derivations as first-class objects),
[`roadmap.md`](../vision/roadmap.md) (Phase E/F),
`crates/kernel/hol/init/src/wasm/SKELETONS.md` (open increments).
`covalence-spectec` crate details in the **crate-map** skill.
