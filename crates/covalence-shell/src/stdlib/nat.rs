...
//! forms (Peano axioms, arithmetic laws) come from
//! `covalence_hol::nat_axioms` and are re-exported here.
//!
...
// Re-export HOL axioms about nat.
pub use covalence_hol::nat_axioms::{
    nat_add_assoc as axiom_add_assoc, nat_add_comm as axiom_add_comm,
    nat_add_zero_l as axiom_add_zero_l, nat_add_zero_r as axiom_add_zero_r,
    nat_induction as axiom_induction, nat_mul_add_distrib_l as axiom_mul_add_distrib_l,
    nat_mul_assoc as axiom_mul_assoc, nat_mul_comm as axiom_mul_comm,
    nat_mul_zero_l as axiom_mul_zero_l, nat_mul_zero_r as axiom_mul_zero_r,
    nat_succ_def as axiom_succ_def, nat_succ_inj as axiom_succ_inj,
...
mod tests {
    ...
    #[test]
    fn axioms_are_well_formed_and_cached() {
        let a = axiom_induction();
        let b = axiom_induction();
