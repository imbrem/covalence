 ...
 *   https://github.com/BLAKE3-team/BLAKE3/blob/1.8.5/c/blake3.c
 * Upstream commit: 93a431c78a52d7ccf0f366f106467f5070e6075e
 * License: CC0 1.0 OR Apache-2.0.
 *
 * Pristine apart from dropping `<assert.h>` / `<string.h>` (the
 * freestanding wasm32-unknown-unknown build has no libc). Required
 * memcpy / memset / strlen / assert come via "cov_compat.h", which
 * blake3_impl.h includes transitively.
 */
