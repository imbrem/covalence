;; Store try-exists missing: try-exists("missing") on empty store, verify returns false. Attest.
(component
    ...
    (core module $m
        ...
        (func $start
            ...
            ;; try-exists(handle, "missing") → should return 0 (false)
            (if (i32.ne (call $store_try_exists (local.get $handle) (i32.const 0) (i32.const 7)) (i32.const 0))
                (then (unreachable))
            )
