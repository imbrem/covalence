...
[`kernel-design.md`](./kernel-design.md), [`roadmap.md`](./roadmap.md),
[`what-is-the-tcb.md`](./what-is-the-tcb.md), the vibes index
...
[`what-is-the-tcb.md`](./what-is-the-tcb.md). The machine-tracked dependency
...
- Design: [`kernel-design.md`](./kernel-design.md),
  [`closed-world-kernel.md`](./closed-world-kernel.md),
  [`base-abstraction.md`](./base-abstraction.md),
  [`base-api-surface.md`](./base-api-surface.md).
...
- Vision context: [`frontend.md`](./frontend.md),
  [`surface-compiler.md`](./surface-compiler.md).
...
- Composes with: [`wasm-spec.md`](./wasm-spec.md), `covalence-spectec`
...
- Design corpus: [`base-abstraction.md`](./base-abstraction.md) §4–5,
  [`base-relcalc-holomega-design.md`](./base-relcalc-holomega-design.md),
  [`tcb-holomega-roadmap.md`](./tcb-holomega-roadmap.md) (Fronts D/E).
...
- Design: [`literal-endgame-design.md`](./literal-endgame-design.md),
  [`eg5-preflight.md`](./eg5-preflight.md),
  [`tcb-holomega-roadmap.md`](./tcb-holomega-roadmap.md) (Front A).
...
- Design: [`base-relcalc-holomega-design.md`](./base-relcalc-holomega-design.md),
  [`tcb-holomega-roadmap.md`](./tcb-holomega-roadmap.md),
  [`tcb-holomega-worklog.md`](./tcb-holomega-worklog.md),
  [`tcb-review-2026-07.md`](./tcb-review-2026-07.md).
- Surface: the HOL-ω reflection ops in `crates/kernel/base` (unconsumed today —
  [`base-api-surface.md`](./base-api-surface.md) §C).
...
- Vision: [`web-kernel.md`](./web-kernel.md), [`wasm3-rust.md`](./wasm3-rust.md).
